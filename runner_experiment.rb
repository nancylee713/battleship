...
# TO DO
# - player cannot fire upon cell that is already fired fire_upon --> user informed
# - friendlier prompts
# - refactor runner
# - end of game returns back to the main file
...
class PlayBoardGame
  ...
  def start
    ...
    @user.user_place_ship(@cruiser)

    # Same for submarine
    @prompts.inquire_submarine_placement

    @user.user_place_ship(@submarine)
